...
class population{
 public:
  ...
  int ntbd, ntbdet, ntbsc, ntbdh, ntbdeth, nod, dethhno, dethhno1549, ntbdetprev, iptends;
  int ntbdetsp, ntbdetf, newhhcount, bdcount;//smr+ dets, fast dets, kid infections, background death count
  double av, av1,av2, av3, av4, av5, tauav, prevhh, tbavd, tbav, ARTnum, ARTdenom, shivcount, foibar, hhfoibar, tbcoprev, hivcoprev;
  double avAdeath;
  double propFI, propFIP, propFD, propIH, propDH, propDS, prevHHH, taurx, foik, rfoi, propECF, propViaF;
  int nophhi, nochhi, nohhart, nohhipt, notecf, nodtecf, cipth;//number household experienced/ hhART /hhIPT  
