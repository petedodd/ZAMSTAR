...
class results{
 ...
 public:
  ...
  //double dt, starttime;
  vector< double > time;
  vector< vector< double > >  ibmN, ibmS, ibmL, ibmrL, ibmLP,ibmLN,ibmD,ibmD2,ibmT,ibmT2, ibmnbcrx, ibmnintrx, ibmHIV, ibmHIV2, ibm1549, ibmu12;
  vector< vector< double > >  ibmFI,ibmFIP, ibmFD,  ibmDS, ibmIH, ibmDH, ibmSP;
  vector< vector< double > >  ibmFOI, ibmARI, ibmARIA, TBdeaths, TBdeathavA, TBpropRetx, HIVdeaths, TBHIVdeaths, ibmFHH, ibmPHH, ibmPHHH, ibmPhh, ibmPHhh;;
  vector< vector< double >  > propThiv, tbnotes, ibmHHPI, ibmHHipt, ibmHHart, ibmpECF;
  vector< vector< double >  >  ibmvECF, ibmARTp, ibmARTe, ibmPRec, ibmSHIVcount, rxcat;
  ...
  vector< vector< vector < double > >  > ibmrx; /* treatment type prevalences */
    vector< vector< vector < double > >  > ibmrxcp; /* treatment type continuation phase prevalences */
  /* for dss */
 ...
 results( int n = 1, int n2 = 1, int m = 1000, bool L = false):
  light(L), noruns(n), notime(m), Dm(0), ARIm(0), Im(0), Dsqm(0), ARIsqm(0), Isqm(0),Itmp(0), aritmp(0),
    time( m, 0 ),ibmN( n, vector< double >(m,0) ),ibmS( n, vector< double >(m,0) ), ibmL( n, vector< double >(m,0) ),ibmrL( n, vector< double >(m,0) ), ibmLP( n, vector< double >(m,0) ),ibmLN( n, vector< double >(m,0) ), ibmD( n, vector< double >(m,0) ),ibmD2( n, vector< double >(m,0) ), ibmT( n, vector< double >(m,0) ),ibmT2( n, vector< double >(m,0) ),  ibmnbcrx( n, vector< double >(m,0)), ibmnintrx( n, vector< double >(m,0)),ibmHIV( n, vector< double >(m,0) ),
    ...
    ibmFOI( n, vector< double >(m,0) ), ibmARI( n, vector< double >(m,0) ),ibmARIA( n, vector< double >(m,0) ), TBdeaths( n, vector< double >(m,0) ),TBdeathavA( n, vector< double >(m,0) ), TBpropRetx( n, vector< double >(m,0) ), HIVdeaths( n, vector< double >(m,0) ), TBHIVdeaths( n, vector< double >(m,0) ),
    ...
    ibmpECF( n, vector< double >(m,0) ), ibmvECF( n, vector< double >(m,0) ), ibmARTp( n, vector< double >(m,0) ),ibmARTe( n, vector< double >(m,0) ), ibmPRec( n, vector< double >(m,0) ),ibmSHIVcount( n, vector< double >(m,0) ),rxcat( n, vector< double >(m,0) ), Inc( n, vector< double >(m,0) ),
    EP1(n2,0), EP2(n2,0), EP3(n2,0), mortz( n2, vector< double >(4,0) ), cd4hist( m, vector< double >(20,0) ), IRR( n, vector< double >(m,0) ), IRRa( n, vector< double >(m,0) ), strIn( n, vector< double >(m,0) ), strIp( n, vector< double >(m,0) ), strIa( n, vector< double >(m,0) ), strIpna( n, vector< double >(m,0) ), strIf( n, vector< double >(m,0) ),strIpf( n, vector< double >(m,0) ),strInf( n, vector< double >(m,0) ), IPTprev( n, vector< double >(m,0) ), IPTprevP( n, vector< double >(m,0) ), IPTprevA( n, vector< double >(m,0) ),IPTprevN( n, vector< double >(m,0) ), IPTch( n, vector< double >(m,0) ), 
    ibmrx( 24, vector< vector< double > > (n , vector< double >(m,0)) ), ibmrxcp( 24, vector< vector< double > > (n , vector< double >(m,0)) ),
    P( 10, vector< double > (10 , 0 ) ) {}
