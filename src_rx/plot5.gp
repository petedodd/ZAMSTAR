...
set size 1.0,0.5;
set multiplot; set origin 0.0,0.0; set size 0.5,1.0; set yrange [0:*]; set xrange [2000:*]; set xlabel "year"; set ylabel "% (interventions)"; plot "../data/results5.dat" u 1:(100*$2) title "prevalence of HH" w li ,"../data/results5.dat" u 1:(100*$3) title "prevalence of past HH IPT" w li ,"../data/results5.dat" u 1:(100*$4) title "prevalence of HH art" w li ;
